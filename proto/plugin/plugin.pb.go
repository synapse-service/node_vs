...
func (x *Input) GetSettings() *Settings {
	if x, ok := x.GetData().(*Input_Settings); ok {
		return x.Settings
	}
	return nil
}

func (x *Input) GetImage() *Image {
	if x, ok := x.GetData().(*Input_Image); ok {
		return x.Image
	}
	return nil
}
...
func (x *Output) GetEvent() *Event {
	if x, ok := x.GetData().(*Output_Event); ok {
		return x.Event
	}
	return nil
}

func (x *Output) GetImage() *Image {
	if x, ok := x.GetData().(*Output_Image); ok {
		return x.Image
	}
	return nil
}
...
type Output_Event struct {
	Event *Event `protobuf:"bytes,1,opt,name=event,proto3,oneof"`
}

type Output_Image struct {
	Image *Image `protobuf:"bytes,2,opt,name=image,proto3,oneof"`
}

func (*Output_Event) isOutput_Data() {}

func (*Output_Image) isOutput_Data() {}
...
type Event struct {
	...
	Type EventType `protobuf:"varint,1,opt,name=type,proto3,enum=node_vs.EventType" json:"type,omitempty"`
	Name string    `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"` // bytes bytes = 3;
}
...
var file_plugin_plugin_proto_rawDesc = []byte{
	...
	,
	...
	0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x18, 0x0a, 0x14, 0x45, 0x56, 0x45, 0x4e, 0x54,
	0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x48, 0x45, 0x41, 0x52, 0x54, 0x42, 0x45, 0x41, 0x54, 0x10,
	0x01, 0x42, 0x0e, 0x5a, 0x0c, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x6c, 0x75, 0x67, 0x69,
...
var file_plugin_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_plugin_plugin_proto_goTypes = []interface{}{
	(EventType)(0),   // 0: node_vs.EventType
	(*Input)(nil),    // 1: node_vs.Input
	(*Settings)(nil), // 2: node_vs.Settings
	(*Image)(nil),    // 3: node_vs.Image
	(*Output)(nil),   // 4: node_vs.Output
	(*Event)(nil),    // 5: node_vs.Event
}
var file_plugin_plugin_proto_depIdxs = []int32{
	2, // 0: node_vs.Input.settings:type_name -> node_vs.Settings
	3, // 1: node_vs.Input.image:type_name -> node_vs.Image
	5, // 2: node_vs.Output.event:type_name -> node_vs.Event
	3, // 3: node_vs.Output.image:type_name -> node_vs.Image
	0, // 4: node_vs.Event.type:type_name -> node_vs.EventType
